...
export class LecturersService {
  ...
  public addLecturer(empid, fname, lname, faculty, department, center, building, level,rank) {
    return this.http.post(`${AppConfig.environment}/lecturers`, {empid, fname, lname, faculty, department, center, building, level,rank});
  }
