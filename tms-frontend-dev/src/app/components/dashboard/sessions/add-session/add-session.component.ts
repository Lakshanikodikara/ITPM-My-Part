    ...
    this.sessionsService
      ...
      .subscribe(
        ...
        (err) => {
          ...
          console.log(err.message);
        console.log(this.selectedLecturer+ " lec: " + this.id +" ID: "+ this.selectedSubject +" Sub "+ this.selectedTag +" tag "+ this.selectedGroup + " group " + this.studentCount + " count " + this.duration+" duration ");
